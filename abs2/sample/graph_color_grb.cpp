/// @file graph_color_grb.cpp
/// @author Koji Nakano
/// @brief Solves randomly generated Graph Coloring Problem using QUBO++ Gurobi
/// Optimizer.
/// @version 2024-10-16
...
/// Problem using the Gurobi Optimizer.
...
int main(int argc, char **argv) {
  ...
  auto grb_model = qbpp_grb::QuadModel(model);
