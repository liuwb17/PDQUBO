/// @file ilp_exhaustive.cpp
/// @brief Solves an Integer Linear Programming (ILP) problem using
/// ExhaustiveSolver through QUBO++ library.
/// @details
/// This is a sample program to solve an Integer Linear Programming
/// (ILP) problem using ExhaustiveSolver through QUBO++ library.
/// @author Koji Nakano
...
int main() {
  ...
  size_t i = 0;
  for (auto sol : sols) {
    std::cout << "Solution " << ++i << " = " << sol << std::endl;
